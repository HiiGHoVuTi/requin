...
#question(0)[Donner la fusion des arbres suivants: FIXME
/*#align(center, grid(
  columns: (1fr, 1fr),
  tree($1$, $2$, $4$),
  tree($3$, $5$, $6$)
...
#correct[
  ...
  En effet, l'appel FIXME /* #grid(columns: (1fr, 1fr, 1fr), tree(`fusion`, $alpha_k (x_1...x_k)$, $x_(k+1)$), "renvoie l'arbre", tree($x_(k+1)$, $alpha_k (x_1 ... x_k)$, $$)) */
