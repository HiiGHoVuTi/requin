...
#q(1)[Expliciter les séquents additionnels pour l'égalité.]

#q(2)[Montrer que $forall x forall y forall z med (x+y) + z = x + (y + z)$ est prouvable.]
...
#q(1)[Montrer que le langage miroir (les mots renversés) d'un langage rationnel est rationnel.]
#q(2)[Montrer que $cal(L)$ est rationnel.]
...
#q(2)[Montrer que toute formule de la forme $A = B$ est rationnelle.]

#q(2)[Montrer que toute formule sans quantificateur est rationnelle.]

#q(3)[Montrer que toute formule de la forme $exists x P$ est rationnelle.]

#q(2)[En déduire que la logique du premier ordre sur $(NN, +, =)$ est décidable.]

#q(2)[Montrer que l'arithmétique de Presburger est décidable.]
