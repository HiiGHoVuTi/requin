...
Soit $n in NN^*$, on défini $Sigma_n = {a_1, overline(a_1),..., a_n, overline(a_n)}$. Les lettres $a_i$ représentent des parenthèses ouvrantes et les lettres $overline(a_i)$ représentent des parenthèses fermantes.
