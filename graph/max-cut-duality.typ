...
#question(0)[Montrer qu'un ensemble $D subset.eq A$ est inclus dans une coupe si et seulement si son complémentaire $A - D$ est une couverture impaire.]
#question(1)[En déduire qu'un ensemble est inclus dans une coupe maximum si et seulement si son complémentaire est une couverture impaire minimum.]
...
#question(1)[Montrer que $(G\/e)^dagger = G^dagger - e^dagger$ et $(G - e)^dagger = G^dagger\/e^dagger$.]
#question(2)[Montrer $D$ est une couverture impaire si et seulement si $D^dagger$ est un couplage impair.]
#question(2)[Montrer que $D$ est un couplage impair minimum si et seulement si $D$ est un ensemble de chemins arête-disjoints
...
#question(2)[Que dire d'un couplage parfait de poids maximal dans $G_c$ ?]

#question(1)[Donner un algorithme qui calcule une coupe maximum dans un graphe planaire.]
