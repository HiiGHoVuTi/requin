...
#question(0)[Donner la complexité de #alg1.]

#question(1)[Démontrer la correction de #alg1.]

#question(1)[Proposer une variante vise qui cherche à minimiser la taille de $F$ à tout instant.]
...
#question(1)[Montrer que si on arrête l'algorithme à un instant,
  puis le relance sur $GT$, on peut reconstituer un ACM de $G$.]

#question(3)[Moyennant un précalcul en $cal(O)(n)$ et 
...
#question(2)[En déduire un algorithme qui calcue un arbre couvrant minimal de $G$ en temps linéaire.]

// TODO: détailler la structure de fou malade ?
